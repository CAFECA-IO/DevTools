...
import { buildAccountTree } from '@/tools/account/build_account_tree';
import { createAccountElementsForSeederByBFS } from '@/tools/account/create_account_elements_for_seeder';
...
const accountElementsJsonPath = path.resolve(__dirname, '../../outputs/account.json');
